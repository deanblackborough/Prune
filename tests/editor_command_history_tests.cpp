...
TEST_CASE("A new editor command history is empty", "[editor][command-history]")
{
...
TEST_CASE("Recording an editor command makes it undoable", "[editor][command-history]")
{
    prune::EditorCommandHistory history;
...
TEST_CASE("Undo and redo move the applied command cursor", "[editor][command-history]")
{
    prune::EditorCommandHistory history;
    history.record(make_command("First command"));
...
TEST_CASE("Recording after undo discards the redo branch", "[editor][command-history]")
{
    prune::EditorCommandHistory history;
    history.record(make_command("First command"));
...
TEST_CASE("Clearing editor command history resets commands and cursor", "[editor][command-history]")
{
    prune::EditorCommandHistory history;
    history.record(make_command("First command"));
    history.record(make_command("Second command"));
