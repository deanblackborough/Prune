    ...
    void Artillery::draw(ArtilleryState& state)
    {
        ...
        if (tooling::imgui::layout::collapsing_header("Player Aims")) {
            if (tooling::imgui::property_table::begin("##artillery_player_aims")) {
                tooling::imgui::property_table::slider_float("P1 Angle", "##artillery_p1_angle", state.player_one_aim.angle_degrees, 5.0f, 85.0f, "%.1f");
                tooling::imgui::property_table::slider_float("P1 Power", "##artillery_p1_power", state.player_one_aim.power, state.options.min_power, state.options.max_power, "%.1f");
                tooling::imgui::property_table::slider_float("P2 Angle", "##artillery_p2_angle", state.player_two_aim.angle_degrees, 5.0f, 85.0f, "%.1f");
                tooling::imgui::property_table::slider_float("P2 Power", "##artillery_p2_power", state.player_two_aim.power, state.options.min_power, state.options.max_power, "%.1f");
                tooling::imgui::property_table::end();
            }
        }
