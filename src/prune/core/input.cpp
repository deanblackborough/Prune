...
namespace prune {
  ...
  bool Input::is_key_down(SDL_Scancode key) const { return m_keys_down[key]; }
  ...
  int Input::mouse_x() const { return m_mouse_x; }

  int Input::mouse_y() const { return m_mouse_y; }

  int Input::mouse_delta_x() const { return m_mouse_delta_x; }

  int Input::mouse_delta_y() const { return m_mouse_delta_y; }

  float Input::mouse_wheel_delta() const { return m_mouse_wheel_delta; }
