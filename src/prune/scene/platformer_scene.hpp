...
namespace prune {
    ...
    public:
        ...
        // Optional scene features: this scene has a camera and a grid.
        [[nodiscard]] SceneCamera* get_camera() noexcept override;
        [[nodiscard]] GridOptions* get_grid_options() noexcept override;
