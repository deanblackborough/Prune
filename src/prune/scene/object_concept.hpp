...
namespace prune {
  ...
  namespace object_concepts {
    ...
    [[nodiscard]] inline constexpr ObjectConcept
    fallback_for(const GameObject& object) noexcept {
      return object.identity.type == GameObjectType::Runtime ? runtime_object
                                                             : scene_object;
    }
