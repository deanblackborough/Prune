...
namespace prune::platformer_factory {
  ...
  GameObject create_player() {
    ...
    player.render.sprite.sprite_key =
        std::string(k_default_player_platformer_sprite_key);
  ...
  GameObject create_platform(float x, float y, int width, int height,
                             const char* name) {
    GameObject platform;
  ...
  GameObject create_hazard(float x, float y) {
    return create_hazard(x, y, k_default_object_size, k_default_object_size,
                         "Hazard");
  }

  GameObject create_hazard(float x, float y, int width, int height,
                           const char* name) {
    GameObject hazard;
