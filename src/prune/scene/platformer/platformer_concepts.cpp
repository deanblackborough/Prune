...
namespace prune::platformer_concepts {
  ...
  const char* purpose(ObjectKind kind) noexcept {
    switch (kind) {
    case ObjectKind::Player:
      return "The single controlled actor for the Platformer slice. The game "
             "camera follows this object.";
    case ObjectKind::PlayerStart:
      return "Authored reset marker used when the player hits a hazard or "
             "falls out of the level.";
    case ObjectKind::Platform:
      return "An authored solid surface the player can stand on or collide "
             "with.";
    case ObjectKind::Hazard:
      return "An authored trigger that resets the player to the player start "
             "marker on contact.";
    case ObjectKind::SceneObject:
    default:
  ...
  const char* collision_rule(ObjectKind kind) noexcept {
    ...
    case ObjectKind::Platform:
      return "Solid. Blocks horizontal movement and provides grounded state "
             "when landed on.";
    case ObjectKind::Hazard:
      return "Trigger only. It is not solid, but player contact causes a "
             "reset.";
    case ObjectKind::SceneObject:
    default:
  ...
  ObjectConcept describe(ObjectKind kind) noexcept {
    switch (kind) {
    case ObjectKind::Player:
      return {"platformer.player",
              "Player",
              "The single controlled actor for the Platformer slice. The game "
              "camera follows this object.",
              ...
              true};
    case ObjectKind::PlayerStart:
      return {"platformer.player_start",
              "Player Start",
              "Authored reset marker used when the player hits a hazard or "
              "falls out of the level.",
    ...
    case ObjectKind::Platform:
      return {
          ...
          "Solid. Blocks horizontal movement and provides grounded state when "
          "landed on.",
          false,
          true,
          true};
    case ObjectKind::Hazard:
      return {
          "platformer.hazard",
          "Hazard",
          "An authored trigger that resets the player to the player start "
          "marker on contact.",
