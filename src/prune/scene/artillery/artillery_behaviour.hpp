...
namespace prune {
    ...
    public:
        void update(SceneState& state, SceneCamera& camera, ArtilleryState& artillery_state, float dt, const Input& input, bool keyboard_input_enabled) const;
    ...
    private:
        ...
        [[nodiscard]] bool projectile_hit_solid(const SceneState& state, const GameObject& projectile, GameObjectId& hit_id) const noexcept;
    };
